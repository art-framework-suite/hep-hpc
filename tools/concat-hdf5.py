...
def parse_args():
    ...
    parser.add_argument('--output', '-o', help='Name of HDF5 output file (obligatory option argument).')
...
class HDF5FileConcatenator:
    def __init__(self, output, append, mem_max, filename_column, only_groups, verbose):
        self._mem_max_bytes = mem_max * 1024 * 1024
        self._filename_column = filename_column
        self._verbose = verbose
        self._output_file = h5py.File(output, 'a' if append else 'w-')
        self._ds_out = {}
